...
<!-- Slide1 -->
   <section class="slide1">
      <div class="wrap-slick1">
         <div class="slick1">
            <div class="item-slick1 item1-slick1" style="background-image: url(images/main_img.jpg);">
            ...
            <div class="item-slick1 item3-slick1" style="background-image: url(images/main4.jpg);">
               <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
         ...
         <div class="wrap-slick2">
            <div class="slick2">
                   ...
                   <?php
                     ...
                     $sql="select * from item where state='recomm'";
               ...
               <div class="item-slick2 p-l-15 p-r-15">
                  ...
                  <div class="block2">
                     <div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
                        <img src="images/<?= $pname ?>.jpg" alt="IMG-PRODUCT" class="product_img">
...
<!------------ 여기서부터 추천상품 ----------------->
                    <?php
                     $con = mysqli_connect("localhost", "shinshopping", "sangwoo159!", "shinshopping");
                     $sql="select * from item where state='new'";
                     $result=mysqli_query($con, $sql);
                     while($row = mysqli_fetch_assoc($result)){
                     $num =$row['num'];
                      $pname =$row['pname'];
         ...
         <div class="row">
            <div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
               <div class="hov-img-zoom pos-relative">
                  <img src="images/main_sub1.jpg" alt="IMG-BANNER">
