...
<?php
	...
	{
		$new_page = $page-1;
		echo "<li><a href='message_box.php?mode=$mode&page=$new_page'>◀ Back</a> </li>";
	}		
	else 
		echo "<li>&nbsp;</li>";
   	...
   	{
		$new_page = $page+1;	
		echo "<li> <a href='message_box.php?mode=$mode&page=$new_page'>Next ▶</a> </li>";
	}
	else 
		echo "<li>&nbsp;</li>";
?>
			...
			<ul class="buttons">
				...
				<li><button class="mbtn" onclick="location.href='message_box.php?mode=send'">Sent Mailbox</button></li>
				<li><button class="mbtn" onclick="location.href='message_form.php'">Send</button></li>
			</ul>
	</div> <!-- message_box -->
</section> 
